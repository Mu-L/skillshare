...
> [!NOTE]
> **最新版本**：每一版的新功能與修正都列在 [Releases](https://github.com/runkids/skillshare/releases) 和[更新紀錄](https://skillshare.runkids.cc/changelog)。近期重點是 **MCP 連線**、**完整 plugin** 的安裝與同步，以及**重新設計的網頁儀表板**。
